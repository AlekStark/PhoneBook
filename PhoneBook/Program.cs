...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Сокращенный вариант если направление совпадает можно использовать var sortPhoneBook = from s in phoneBook orderby s.Name, s.LastName descending(по убыванию) select s;
